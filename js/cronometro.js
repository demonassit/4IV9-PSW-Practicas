...
let alamacenarTiempos = document.getElementById('almacenarTiempos');
...
function resetearContador(){
    ...
    clearInterval(intervalo);
    while(alamacenarTiempos.firstChild){
        alamacenarTiempos.removeChild(alamacenarTiempos.firstChild);
    }
}
...
function grabarContador(){
    if(temporizador.textContent === '0.00'){
        ...
        `;
        alamacenarTiempos.appendChild(p);
    }
}